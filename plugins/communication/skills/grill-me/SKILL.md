...
| more, with the `Artifact` tool in the session | the `#round` form of `${CLAUDE_PLUGIN_ROOT}/page.html`, recommendations prefilled, its button clicked once, published with that tool |
