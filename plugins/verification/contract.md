...
- Read the bar where the repo states it (CI, a contributing guide, agent instructions); with none stated, every check the change touches passes. Asked where verification stands, give each kind's layout, what it covers, its last result, and the gap to the bar.
