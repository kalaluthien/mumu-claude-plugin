...
3. For each open task whose blockers are all closed: `start` it under its topic at its effort with `--leader <your address>`; a small change you make yourself, as your rules say.
