...
3. For each issue: `checkout`, `start` it under its name at its effort, add its `Worker:` line to your mission, and `prompt` it `/mumu-team:kickoff work <issue-url> leader <your address>`.
