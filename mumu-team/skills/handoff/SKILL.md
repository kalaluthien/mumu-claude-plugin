...
Hand the owner's request to the project's lead: the one session that holds its goals. The words of [kickoff's Domain](${CLAUDE_PLUGIN_ROOT}/skills/kickoff/SKILL.md) and its [verbs](${CLAUDE_PLUGIN_ROOT}/skills/kickoff/references/verbs.md) apply.
