...
A screen is checked by driving it in a browser and asserting what it shows; a Claude plugin's hook, dialog, monitor or `/` menu, by a [plugin probe](references/plugin-probe.md). Run the tests.
